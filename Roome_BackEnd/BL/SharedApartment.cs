...
namespace Roome_BackEnd.BL
{
    public class SharedApartment: AbstractApartment{
        ...
        public SharedApartment() : base(0, 0, 0, "", false, false, false, 0, DateTime.Now, DateTime.Now, true, 0, 0, 0, "")
        {numberOfRoommates = 0;}
        public SharedApartment(
                ...
                int propertyTypeID, int userID, int floor, string description, int numberOfRoommates) 
