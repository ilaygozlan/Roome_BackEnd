...
namespace Roome_BackEnd.BL
{
    public abstract class  AbstractApartment{
        ...
        protected AbstractApartment(int id,int price,int amountOfRooms,int location,bool allowPet,bool allowSmoking,bool gardenBalcony, int parkingSpace,DateTime entryDate, DateTime exitDate,
